...
<div class="container-fluid">
    ...
    <div class="mb-4 d-sm-flex align-items-center justify-content-between">
        <h1 class="mb-0 text-gray-800 h3">Create New Event</h1>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.acara.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nama_acara') is-invalid @enderror" id="nama_acara" name="nama_acara" value="{{ old('nama_acara') }}" required>
                    @error('nama_acara')
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control @error('batas_pendaftaran') is-invalid @enderror" id="batas_pendaftaran" name="batas_pendaftaran" value="{{ old('batas_pendaftaran') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('maksimal_peserta') is-invalid @enderror" id="maksimal_peserta" name="maksimal_peserta" value="{{ old('maksimal_peserta') }}" required min="1">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('deskripsi_acara') is-invalid @enderror" id="deskripsi_acara" name="deskripsi_acara" rows="5" required>{{ old('deskripsi_acara') }}</textarea>
